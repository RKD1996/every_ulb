  ...
  <v-container>
    <v-card>
      <v-card-text>
        <v-layout row wrap>
          <v-flex xs12 sm6>
            <v-card class="mt-4" hover v-for="(t,i) in monitorData"  :key="t.id" :color="colors" @click.native="showMoni(t.topic, t.critical, t.eoi, t.final)">
              <v-card-text>
                <v-layout row wrap>
          ...
          <v-flex xs12 sm6>
            <v-card class="ma-4" color="yellow lighten-3" v-show="drop3 === 'moni'">
              <v-card-title >
...
<script>
  export default {
    ...
    methods: {
      showMoni (topic, critical, eoi, final) {
        this.drop3 = 'moni'
